import { IsOptional, IsInt, IsString, Min, IsIn, IsEnum } from 'class-validator';
import { Transform, Type } from 'class-transformer';
import { NEW_TYPE } from 'utils/enum';

const ALLOWED_SORT_FIELDS = ['title', 'type', 'content', 'created_at'];
...
export class QueryNewsDto {
  ...
  @IsEnum(NEW_TYPE, {
    message: 'Loại tin tức chỉ có thể là 1 hoặc 2',
  })
  type?: NEW_TYPE;
}
